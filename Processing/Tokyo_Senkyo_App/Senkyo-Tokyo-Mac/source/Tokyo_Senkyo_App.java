...
public class Tokyo_Senkyo_App extends PApplet {
...
public void setup(){
  ...
  for(int i=0; i<lines.length; i++){
    ...
    int kuwari = PApplet.parseInt(trim(pieces[0]));
    int party  = PApplet.parseInt(trim(pieces[1]));
    String name = pieces[2];
    int vote   = PApplet.parseInt(trim(pieces[3]));
...
public void DrawPieChart(int x, int y, HashMap Kuwari, HashMap Kouho, int dataMax, int knum){
  ...
  for(int i=1; i<30; i++){
    if(Kuwari.containsKey(i)){
      ...
      else if(i==10){ pattern[j] = 0xff333333; }
      else if(i==11){ pattern[j] = 0xffCC6699; }
      else if(i==12){ pattern[j] = 0xff9933CC; }
      else if(i==13){ pattern[j] = 0xff33CC99; }
      else if(i==14){ pattern[j] = 0xff8080AF; }
      else{ pattern[j] = 0xff333333; }
      j++;
...
public void pieChart(float diameter, float[] data, int[] pattern, String[] namelist, int ChartX, int ChartY, int knum){
  ...
  for(int i=0; i< data.length; i++){
    ...
    else if(party==12){ fill(0xffFF33FF); }
    else if(party==13){ fill(0xff33CC99); }
    else if(party==14){ fill(0xff8080AF); }
...
public void drawKanagawaMap(){
  ...
  PShape caption = new PShape();
   ...
   for(int i=1; i<26; i++){
     ...
     else if(win[i-1] == 13){ c = 0xff33CC99; }
     else if(win[i-1] == 14){ c = 0xff8080AF; }
     else{ c = 0xff333333; }
...
public void DrawTokuhyoChart(){
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[0]) / max) * 100;
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[1]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[2]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);  
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[3]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[4]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);  
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[5]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[6]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[7]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);
  ...
  text("\u6c11\u4e3b\u515a",TokuhyoChartX - 5, TokuhyoChartY + 10);
   tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[8]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9); 
  ...
  text("\u65b0\u515a\u65e5\u672c",TokuhyoChartX - 5, TokuhyoChartY + 10);
   tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[10]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9); 
  ...
  text("\u6b21\u4e16\u4ee3\u306e\u515a",TokuhyoChartX - 5, TokuhyoChartY + 10);
   tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[11]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9); 
  ...
  text("\u4fdd\u5b88\u65b0\u515a",TokuhyoChartX - 5, TokuhyoChartY + 10);
   tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[12]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9);   
  ...
  text("\u56fd\u6c11\u65b0\u515a",TokuhyoChartX - 5, TokuhyoChartY + 10);
   tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[13]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9); 
  ...
  tokuhyoritsu = (PApplet.parseFloat(tokuhyo_goukei[14]) / max) * 100;
  text(nf(tokuhyoritsu,0,1) + "%", TokuhyoChartX + value + 30, TokuhyoChartY + 9); 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Tokyo_Senkyo_App" };
    if (passedArgs != null) {
